  ...
  return (
    <div className="mt-24">
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", marginLeft: "38%" }}>
        ...
        <div style={{ marginLeft: "18%" }}><button type="button" onClick={()=>{window.location.href = 'https://mlcrats-yolov5-e-waste-detection-app-ffzm7i.streamlit.app/';}} target="_blank" class="btn btn-success" style={{ backgroundColor: "limegreen", borderRadius: "16%" }}>Submit Input</button></div>
      </div>
